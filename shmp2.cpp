...
//instantiation of struct BUS with values
//most important is to note the seats left which are 20
...
int main(int argc, char *argv[])
{
     ...
     //displays to console the components of BUS struct instantiated in line 17
